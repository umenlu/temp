...
window.onload=function ()
{
	...
	for(i=0;i<aLi.length;i++)
	{
		...
		aLi[i].onmouseover=function ()
		{
			...
			miaovStartMove2(oImg, {width:130}, MIAOV_MOVE_TYPE.FLEX, function (){
				css(this, 'marginLeft', -64);
			}, duringA);
			
			miaovStartMove2(oA, {top: 0, paddingTop: 100, paddingBottom: 36}, MIAOV_MOVE_TYPE.FLEX);
			miaovStartMove2(oBg, {height:100}, MIAOV_MOVE_TYPE.BUFFER);
		};
